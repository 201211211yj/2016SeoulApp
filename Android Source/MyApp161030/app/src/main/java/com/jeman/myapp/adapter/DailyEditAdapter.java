 ...
 */public class DailyEditAdapter extends BaseAdapter {
    ...
    public DailyEditAdapter(Context c , ArrayList<menuclass> arrays, userInfo userinfo){
        this.mContext = c;
    ...
    public View getView(final int position, View convertview, ViewGroup parent) {
        ...
        if(v == null){
            ...
            v = inflater.inflate(R.layout.myschool_dailyedit_listitem, null);
            viewHolder.ed_menu = (EditText)v.findViewById(R.id.dailyed_li_menu);
            viewHolder.ed_from = (EditText)v.findViewById(R.id.dailyed_li_from);
    ...
    class ViewHolder{
        public EditText ed_menu = null;
        public EditText ed_from = null;
    }
    @Override
